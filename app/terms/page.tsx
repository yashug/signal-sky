    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="prose prose-sm prose-neutral dark:prose-invert max-w-none space-y-8 text-sm text-muted-foreground leading-relaxed [&_h2]:text-foreground [&_h2]:text-base [&_h2]:font-semibold [&_h2]:mt-8 [&_h2]:mb-3 [&_strong]:text-foreground">
          ...
          <p>
            By accessing or using SignalSky (&quot;the Service&quot;), operated by the entity below (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), you agree to be bound by these Terms of Service. If you do not agree, please do not use the Service.
          </p>

          <h2>2. Service Provider &amp; Business Information</h2>
          <p>
            The Service is operated by a <strong>Sole Proprietorship</strong> under the trade name <strong>YG IT Global Solutions</strong>.
          </p>
          ...
          <h2>5. Free Trial &amp; Subscriptions</h2>
          <p>
          ...
          <h2>7. Disclaimer — Not Financial Advice</h2>
          <p>
