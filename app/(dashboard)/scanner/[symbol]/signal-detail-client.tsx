...
import type { ApiSignal, ApiSignalChart, HeatStatus } from "@/lib/api"
...
export function SignalDetailClient({
  ...
  }, [capital, signal.price, lastEdited])
  ...
  }, [shares, signal.price, lastEdited])
  ...
  async function logTrade() {
    if (!tradeCalc || tradeCalc.qty <= 0) return
          ...
          {chartDataFormatted.length > 0 ? (
            <ChartContainer config={chartConfig} className="flex-1 w-full min-h-[260px]">
              ...
              >
                ...
                <ReferenceLine
                  y={(chartData as any)?.ath ?? signal.ath}
