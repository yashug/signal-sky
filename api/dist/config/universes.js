...
export const ALL_UNIVERSE_TAGS = [
    "nifty50", "niftynext50", "nifty200",
    "niftymidcap50", "niftymidcap100",
    "niftysmallcap50", "niftysmallcap100",
    "niftybank",
...
export function resolveUniverseTags(key) {
    return UNIVERSE_GROUPS[key]?.tags ?? ALL_UNIVERSE_TAGS;
}
/** Label map for market health display */
export const UNIVERSE_LABELS = Object.fromEntries(Object.entries(UNIVERSE_GROUPS).map(([k, v]) => [k, v.label]));
